    ...
    <section className='container'>
      <div className='archive'>
        ...
        <ul className='archive__list'>
          <li className='archive__items'><button className={`archive__btn archive__btn--secondary ${(cards==='dev')? ('archive__btn--secondary--active'):''}`} onClick={this.handleOnClick} value='dev'>Development</button></li>
          <li className='archive__items'><button className={`archive__btn archive__btn--secondary ${(cards==='design')? ('archive__btn--secondary--active'):''}`} onClick={this.handleOnClick} value='design'>Design</button></li>
        </ul>
