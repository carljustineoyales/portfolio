                  ...
                  <div className='experience__card experience__card--active'>
                    <div className='experience__card-header experience__card-header--active'>
                      <h3 className='experience__company'>
                        DecodeTokyo</h3>
                      <h4 className='experience__duration'>January 2020 - Present</h4>
                    </div>
                ...
                <div className='experience__items'>
                  <div className='experience__card'>
                    <div className='experience__card-header'>
                      ...
                      <h4 className='experience__duration'>August 2019 - November 2019</h4>
                    </div>
                    <div className='experience__card-body'>
                ...
                <div className='experience__items'>
                  <div className='experience__card'>
                    <div className='experience__card-header'>
                      ...
                      <h4 className='experience__duration'>April 2018 - March 2018</h4>
                    </div>
                    <div className='experience__card-body'>
                      <h2 className='experience__position'>Production Engineer (Intern)</h2>
                      <p className='experience__position-desc'>FProduction engineers work in the
